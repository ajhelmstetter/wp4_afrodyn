...
for(i in 1:length(list_gen)){
  ...
  #scan diversity
  sD<-scanDiv(Dscan = 0.5, Radius = Radius, refD = refD,datageo=list_datageo[[i]],geodist=list_geo[[i]])
...
save.image(file="~/Dropbox/projects/AJH_WP4_AFRODYN/results/currentDiv.Rdata")
